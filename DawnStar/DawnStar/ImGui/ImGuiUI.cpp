...
namespace DawnStar
{    
    void ImGuiUI::DrawVec3Control(const std::string& label, glm::vec3& values, float resetValue, float columnWidth)
    {
    ...
    void ImGuiUI::DrawVec2Control(const std::string& label, glm::vec2& values, 
                                  const glm::vec2 minValue, const glm::vec2 maxValue, 
                                  const float speed, float resetValue, float columnWidth)
    {
        ...
        ImGui::SameLine();
        ImGui::DragFloat("##X", &values.x, speed, minValue.x, maxValue.x, "%.2f");
        ImGui::PopItemWidth();
        ImGui::SameLine();
        ...
        ImGui::SameLine();
        ImGui::DragFloat("##Y", &values.y, speed, minValue.y, maxValue.y, "%.2f");
        ImGui::PopItemWidth();
        ImGui::SameLine();
